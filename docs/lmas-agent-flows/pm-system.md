...
> **NOTE (2026-04-14):** SLC (Simple, Lovable, Complete) is the default Phase 1 methodology per CONSTITUTION_RULE_9. MVP references are historical. See `framework/references/slc-methodology.md`.

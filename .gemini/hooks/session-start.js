#!/usr/bin/env node
/**
 * LMAS Session Start Hook for Gemini CLI
 * Story GEMINI-INT.6 - LMAS Hooks System
 *
 * Executes at session start to load LMAS context and memory.
...
async function sessionStart() {
  ...
  try {
    const codebaseMapPath = path.join(projectDir, '.lmas', 'codebase-map.json');
